...
public class ConnectionBase {
    ...
    public static void initTables() throws ClassNotFoundException, SQLException {
        Class.forName("org.sqlite.JDBC");
        Connection con = DriverManager.getConnection(URL, USER, PASS);
        String sqlCreateOrderDetail = "CREATE TABLE OrderDetail (id INT PRIMARY KEY NOT NULL,orderHeaderID INT, productName VARCHAR2(100), price REAL NOT NULL ,FOREIGN KEY (orderHeaderID) REFERENCES OrderHeader(id))";
